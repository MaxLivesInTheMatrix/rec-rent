...
function RentModal({}: Props) {
  ...
  let bodyContent = (
    <div className="flex flex-col gap-8">
      <Heading
        title="Which of these best describes your equipment?"
  ...
  if (step === STEPS.INFO) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        ...
        <Counter
          title="Guests"
          subtitle="How many guest do you allow to use your equipment?"
          value={guestCount}
  ...
  if (step === STEPS.DESCRIPTION) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Now, describe your equipment"
          subtitle="How is the condition of your equipment?"
        />
        {/* <Input
          id="title"
          label="Title"
